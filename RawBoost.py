...
def randRange(x1, x2, integer):
    # Return a Python scalar. The original returned a shape-(1,) array and then
    # called int() on it, which is deprecated in NumPy >= 1.25 and raises
    # TypeError on NumPy 2.x ("only 0-dimensional arrays can be converted to
    # Python scalars"), making RawBoost algorithms 1/2/3 crash on a modern stack.
